...
export async function PUT( req, { params } ) {
    try{
        ...
        const result = await sql('UPDATE customers SET customer_name = ?, customer_contact = ?, customer_address = ?, customer_shop_name = ?, customer_credit_limit = ?, subarea_id = ? WHERE customer_id = ?', [customer_name, customer_contact, customer_address, customer_shop_name, customer_credit_limit, subarea_id]);
